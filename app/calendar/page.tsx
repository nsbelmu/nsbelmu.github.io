const Calendar = () => {
  return (
    <div className="motion-opacity-in relative flex flex-col items-center justify-center h-screen">
      <iframe
        ...
        className="motion-blur-in motion-delay-300 w-full h-full p-4 bg-gray-100"
      ></iframe>
    </div>
  );
};
